...
const ATS = ({ score, suggestions }: ATSProps) => {
  const gradientClass =
    score > SCORE_VALUE.high ? "from-green-100" : score > SCORE_VALUE.mid ? "from-yellow-100" : "from-red-100";
  ...
  const subtitle =
    score > SCORE_VALUE.high ? "Great Job!" : score > SCORE_VALUE.mid ? "Good Start" : "Needs Improvement";
