...
export const Accordion = ({ children, defaultOpen, allowMultiple = false, className = "" }: AccordionProps) => {
  ...
  return (
    <AccordionContext.Provider value={{ activeItems, toggleItem, isItemActive }}>{children}</AccordionContext.Provider>
  );
};
...
export const AccordionItem = ({ children, id, className = "" }: AccordionItemProps) => {
